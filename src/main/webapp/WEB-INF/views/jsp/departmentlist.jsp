                                            ...
                                            <table id="example" class="table table-bordered table-hover">
                                                ...
                                                <%--      <td>
                                                    ...
                                                    <td><span class="label-default label label-danger">Inactive</span></td>
                                                     ...
                                                     <td>
                                                        <a href="/doctor/list/${department.departmentid}" class="btn btn-info btn-xs"><i class="fa fa-pencil"></i>
                                                        </a>
                                                        <a href="/doctor/delete/${department.departmentid}" class="btn btn-danger btn-xs"><i class="fa fa-trash-o"></i>
                                                        </a>
                                                    </td>
                                                </tr>
                                                </c:forEach>
