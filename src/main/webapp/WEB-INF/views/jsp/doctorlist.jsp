                            ...
                            <div class="col-sm-12">
                                <div class="panel panel-bd lobidrag">
                                    <div class="panel-heading">
                                        <div class="btn-group"> 
                                            <a class="btn btn-success" href="/doctor/form"> <i class="fa fa-plus"></i> Add Doctor
                                            </a>  
                                        </div>        
                                    </div>
                                            ...
                                            <table id="example" class="table table-bordered table-hover">
                                                ...
                                                <tr >  
                                                     <td>
                                                         ...
                                                         <label>${doctor.docid}</label>   
                                                     </td>
                                                     <td><img src="/resources/upload/${doctor.file}" class="img-circle" alt="User Image" height="50" width="50"></td>
                                                     <td>${doctor.docfname}</td>
                                                     <td>${doctor.doclname}</td>
                                                     <td>${doctor.docdepartment}</td>
                                                    <!--  <td><a href="cdn-cgi/l/email-protection.html" class="__cf_email__" data-cfemail="670a121513061d27130f020a020a0e090e141302154904080a">[email&#160;protected]</a></td> -->
                                                     ...
                                                     <td>${doctor.docmobile}</td>
                                                     <td>${doctor.docspeciallist}</td>
                                                     <td>${doctor.docsex }</td>
                                                     <c:if test="${doctor.docstatus==1}"> 
                                                     <td><span class="label-success label label-default">Active</span></td>
                                                     </c:if>
                                                      <c:if test="${doctor.docstatus==0}"> 
                                                     <td><span class="label-success label label-default">Active</span></td>
                                                     </c:if>
                                                     
                                                     <td>
                                                        <a href="/doctor/list/${doctor.docid}" class="btn btn-info btn-xs"><i class="fa fa-pencil"></i>
                                                        </a>
                                                        <a href="/doctor/delete/${doctor.docid}" class="btn btn-danger btn-xs"><i class="fa fa-trash-o"></i>
                                                        </a>
                                                    </td>
                                                </tr>
                                                </c:forEach>
