                            ...
                            <div class="col-sm-12">
                                <div class="panel panel-bd lobidrag">
                                    ...
                                    <div class="panel-body">
                                        <form class="col-sm-12" action="/save/doctor" method="post"  enctype="multipart/form-data">
                                            <div class="col-sm-6 form-group">
                                                <label>First Name</label>
                                                <input type="text" class="form-control" name="docfname" placeholder="Enter firstname" required>
                                                  <form:errors path="docfname" cssClass="error" />
                                            </div>
                                            <div class="col-sm-6 form-group">
                                                <label>Last Name</label>
                                                <input type="text" class="form-control" name="doclname" placeholder="Enter Lastname" required>
                                            </div>
                                            <div class="col-sm-6 form-group">
                                                <label>Email</label>
                                                <input type="email" class="form-control" name="docemail" placeholder="Enter Email" required>
                                            </div>
                                            <div class="col-sm-6 form-group">
                                                <label>Password</label>
                                                <input type="password" class="form-control" name="docpassword" placeholder="Enter password" required>
                                            </div>
                                            <div class="col-sm-6 form-group">
                                                <label>Designation</label>
                                                <input type="text" class="form-control" name="docdesignation" placeholder="Enter Designation" required>
                                            </div>
                                            ...
                                            <div class="col-sm-6 form-group">
                                                <label>Address</label>
                                                <input type="text" class="form-control" name="docaddress" placeholder="Address" required>
                                            </div>
                                            <div class="col-sm-6 form-group">
                                                <label>Specialist</label>
                                                <input type="text" class="form-control" name="docspeciallist" placeholder="Specialist" required>
                                            </div>
                                            <div class="col-sm-6 form-group">
                                                <label>Mobile</label>
                                                <input type="number" class="form-control" name="docmobile" placeholder="Enter Mobile" required>
                                            </div>
                                            ...
                                            <div class="col-sm-12 form-group">
                                                ...
                                                <textarea id="some-textarea" class="form-control" name="docbio" rows="3" placeholder="Enter text ..."></textarea>
                                            </div>        
                                            <div class="col-sm-6 form-group">
                                                <label>Date of Birth</label>
                                                <input class="datepicker form-control hasDatepicker" name="docbirth" type="date" placeholder="Date of Birth" id="date_of_birth">
                                            </div>
                                            <div class="col-sm-6 form-group">
                                            ...
                                            <div class="col-sm-6 form-group">
                                             ...
                                             <label class="radio-inline">
                                                 <input type="radio" name="docsex" value="Male" checked="checked">Male</label> 
                                                 <label class="radio-inline"><input type="radio" name="docsex" value="Female" >Female</label>
                                             </div>
                                             <div class="col-sm-6 form-group">
                                              <label>Status</label><br>
                                              <label class="radio-inline">
                                             <input type="radio" name="docstatus" value="1" checked="checked">Active</label> 
                                              <label class="radio-inline"><input type="radio" name="docstatus" value="0" >Inactive</label>
                                              </div> 
