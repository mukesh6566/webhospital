                            ...
                            <div class="col-sm-12">
                                <div class="panel panel-bd lobidrag">
                                    ...
                                    <div class="panel-body">
                                         <form action="/save/schedule" method="post" class="col-sm-6">
                                            <div class="form-group">
                                               <label>Doctor</label>
                                                <select class="form-control" id="exampleSelect1" name="docname" size="1">
                                                    <c:forEach items="${doctors}" var="doctor">
                                                    <option>${doctor.docfname}</option>
                                                   </c:forEach>
                                                </select>
                                            </div>
                                             ...
                                             <div class="form-group">
                                                ...
                                                <select class="form-control" id="exampleSelect1" name="departname" size="1">
