          ...
          <!-- Content Header (Page header) -->
                    <section class="content-header">
                        ...
                        <div class="header-title">
                            ...
                            <small>Accepted Appointment list</small>
                            ...
                            <div class="col-sm-12">
                                <div class="panel panel-bd lobidrag">
                                    <div class="panel-heading">
                                        <div class="btn-group"> 
                                            <a class="btn btn-success" href="/department/form"> <i class="fa fa-plus"></i> Add Department
                                            </a>  
                                        </div>        
                                    </div>
                                               ...
                                               <table id="example" class="table table-bordered table-hover">
                                                ...
                                                <tr >  
                                                     ...
                                                     <td>
                                                        ...
                                                        <a href="/appointment/accept/form/${appointment.appointno}" class="btn btn-info btn-xs">Updates
                                                        </a>
                                                    
                                                        <br/><br/>
                                                      
                                                        <a href="/appointment/reject/form/${appointment.appointno}" class="btn btn-danger btn-xs">Delete
                                                        </a>
