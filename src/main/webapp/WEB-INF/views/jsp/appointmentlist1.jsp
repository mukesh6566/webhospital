                            ...
                            <div class="col-sm-12">
                                <div class="panel panel-bd lobidrag">
                                    <div class="panel-heading">
                                        <div class="btn-group"> 
                                            <a class="btn btn-success" href="/accept/all"> <i class="fa fa-plus"></i> Accept All Appointment
                                            </a>  
                                        </div>        
                                    </div>
                                               ...
                                               <table id="example" class="table table-bordered table-hover">
                                                ...
                                                <tr >  
                                                     ...
                                                     <td>
                                                        ...
                                                        <a href="/appointment/accept/form/${appointment.appointno}" class="btn btn-info btn-xs">Accept
                                                        </a>
                                                    
                                                        <br/><br/>
                                                      
                                                        <a href="/appointment/reject/form/${appointment.appointno}" class="btn btn-danger btn-xs">Reject
                                                        </a>
