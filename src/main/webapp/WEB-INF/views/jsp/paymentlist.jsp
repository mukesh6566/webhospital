                            ...
                            <div class="col-sm-12">
                                <div class="panel panel-bd lobidrag">
                                    <div class="panel-heading">
                                        <div class="btn-group"> 
                                            <a class="btn btn-success" href="/patient/show"> <i class="fa fa-plus"></i> Add Payment
                                            </a>  
                                        </div>        
                                    </div>
                                            ...
                                            <table id="example" class="table table-bordered table-hover">
                                                ...
                                                <tr >  
                                                     <td>
                                                         ...
                                                         <label>${payment.paymentid}</label>   
                                                     </td>

                                                     <td>${payment.diagnotype}</td>
                                                     <td>${payment.date}</td>
                                                ...
                                                <td></td>
                                                <td></td>
                                                 <c:if test="${paymentsum!=null}"> 
                                                <td>Total Amount:${paymentsum}</td>
                                                </c:if>
