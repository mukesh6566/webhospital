                            ...
                            <div class="col-sm-12">
                                <div class="panel panel-bd lobidrag">
                                    <div class="panel-heading">
                                        <div class="btn-group"> 
                                            <a class="btn btn-primary" href="/appointment/list"> <i class="fa fa-list"></i>  Appointment List </a>  
                                        </div>
                                    </div>
                                    <div class="panel-body">
                                        <form class="col-sm-12" action="/accept/appointment" method="post">            
                                    <input type="hidden" name="appointno"  value="${appointment.appointno}"/>
<!--                                        <input type="hidden" name="status"  value="2"/>
 -->                                       
                                    
                                      <div class="form-group">
                                        <label>Accept Reason</label>
                                        <textarea class="form-control" name="replymessage" rows="3" required></textarea>
                                    </div>
