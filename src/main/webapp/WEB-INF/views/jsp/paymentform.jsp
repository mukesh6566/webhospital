                            ...
                            <div class="col-sm-12">
                                <div class="panel panel-bd lobidrag">
                                    <div class="panel-heading">
                                        <div class="btn-group"> 
                                            <a class="btn btn-primary" href="/payment/list"> <i class="fa fa-list"></i>  Payment List </a>  
                                        </div>
                                    </div>
                                    <div class="panel-body">
                                        <form class="col-sm-12" action="/add/payment" method="post">
                                        
                                        
                                            <div class="form-group">
                                                <label>Diagnosys Type</label>
                                                <input type="text" name="diagnotype" class="form-control" placeholder="Enter First Name" required>
                                            </div>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <input type="text" name="totamount" class="form-control" placeholder="Enter Mobile" required>
                                            </div>
