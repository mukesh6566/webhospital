                            ...
                            <div class="col-sm-12">
                                <div class="panel panel-bd lobidrag">
                                    <div class="panel-heading">
                                        <div class="btn-group"> 
                                            <a class="btn btn-primary" href="/bed/list"> <i class="fa fa-list"></i>  Bed List </a>  
                                        </div>
                                    </div>
                                    <div class="panel-body">
                                       
                            <form method="post" action="/add/bed" class="col-sm-6">
                                <div class="form-group">
                                    <label>Bed Type</label>
                                    <input type="text" name="bedtype" class="form-control" placeholder="type" required>
                                </div>
                                <div class="form-group">
                                    <label>Description</label>
                                    <textarea name="beddesc" class="form-control" rows="3" placeholder="Enter description..."></textarea>
                                </div>
                                <div class="form-group">
                                    <label>Bed capacity</label>
                                    <input type="number" name="bedcap" class="form-control" placeholder="Enter Bed capacity" required>
                                </div>
