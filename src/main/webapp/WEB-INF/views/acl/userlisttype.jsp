                                          ...
                                          <div class="table-responsive">
                                            <table id="example" class="table table-bordered table-hover">
                                                ...
                                                <tr >  
                                                     ...
                                                     <td><img src="/resources/upload/${hospital.hospitalpic}" class="img-circle" alt="User Image" height="50" width="50"></td>
                                                    ...
                                                    <!--  <td><a href="cdn-cgi/l/email-protection.html" class="__cf_email__" data-cfemail="670a121513061d27130f020a020a0e090e141302154904080a">[email&#160;protected]</a></td> -->
                                                     ...
                                                     <td>
                                                        ...
                                                        <a href="/doctor/delete/${hospital.hospitalid}" class="btn btn-danger btn-xs"><i class="fa fa-trash-o"></i>
                                                        </a>
                                                    </td>
                                                </tr>
                                                </c:forEach>
