...
<!-- Mirrored from healthadmin.thememinister.com/app-list.html by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 14 Mar 2018 12:19:21 GMT -->
<head>
    <meta charset="utf-8">
                        ...
                        <div class="col-sm-12">
                            <div class="panel panel-bd lobidrag">
                                <div class="panel-heading">
                                    <div class="btn-group"> 
                                        <a class="btn btn-success" href="#"> <i class="fa fa-plus"></i>  Add Appionment</a>  
                                    </div>
                                </div>
                              ...
                              <div class="table-responsive">
                                                ...
                                                <tr >  
                                                     ...
                                                     <td>
                                                        <a href="/doctor/list/${department.departmentid}" class="btn btn-info btn-xs">Accept
                                                        </a>
                                                        <a href="/doctor/delete/${department.departmentid}" class="btn btn-danger btn-xs">Reject
                                                        </a>
                                                    </td>
                                                </tr>
                                                </c:forEach>
