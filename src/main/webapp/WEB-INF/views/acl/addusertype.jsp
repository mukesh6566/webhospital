                            ...
                            <div class="col-sm-12">
                                <div class="panel panel-bd lobidrag">
                                    <div class="panel-heading">
                                        <div class="btn-group"> 
                                            <a class="btn btn-primary" href="/hospital/list"> <i class="fa fa-list"></i> User List </a>  
                                        </div>
                                    </div>
                                    <div class="panel-body">
                                        <form class="col-sm-6" action="/add/usertype" method="post"  enctype="multipart/form-data">
                                            <div class="col-sm-12 form-group">
                                                <label>Add UserType</label>
                                                <input type="text" class="form-control" name="usertype" placeholder="Enter hospitalname" required>
                                                  <form:errors path="docfname" cssClass="error" />
                                            </div>
                                   
                                 <div class="reset-button col-sm-6">
