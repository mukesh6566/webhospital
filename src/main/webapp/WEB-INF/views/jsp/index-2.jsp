...
<!-- Mirrored from healthadmin.thememinister.com/index.html by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 14 Mar 2018 12:18:05 GMT -->
<head>
    <meta charset="utf-8">
        ...
        <div class="wrapper">
            <header class="main-header">
                <a href="index-2.html" class="logo"> <!-- Logo -->
                    <span class="logo-mini">
                        <!--<b>A</b>H-admin-->
                        <img src="assets/dist/img/logo.png" width=40px height=40px alt="">
                    </span>
                    <span class="logo-lg">
                        <!--<b>Admin</b>H-admin-->
          ...
          <aside class="main-sidebar">
            ...
            <div class="content-wrapper">
                ...
                <section class="content-header">
                    ...
                    <div class="header-title">
                        ...
                        <small> Hospital Dashboard features</small>
            ...
            <footer class="main-footer">
                ...
                <strong>Copyright &copy; @2018 <a href="#">HospitaleHat</a>.</strong> All rights reserved.
            </footer>
        </div> <!-- ./wrapper -->
        <!-- ./wrapper -->
         <!-- Start Core Plugins
